...
module type Model = sig
  ...
  (** A function for testing whether the model has changed enough to require refiring the
      incremental graph.
...
module type S = sig
  ...
  val create
    ...
    -> inject:(Action.t -> unit Vdom.Effect.t)
         (** [inject] gives you the ability to create event handlers in the virtual DOM.
             In your event handler, call this function on the action you would like to
